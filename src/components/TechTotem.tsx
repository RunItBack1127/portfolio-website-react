        ...
        <div className="expContainer">
            ...
            <div className="gaugeContainer">
                <div className="gaugeInner">
                    <svg className={ props.technology.level >= 1 ? "skill-met" : "" } viewBox="0 0 25 25">
                        <circle cx="12.5" cy="12.5" r="10"></circle>
                    </svg>
                    <svg className={ props.technology.level >= 2 ? "skill-met" : "" } viewBox="0 0 25 25">
                        <circle cx="12.5" cy="12.5" r="10"></circle>
                    </svg>
                    <svg className={ props.technology.level >= 3 ? "skill-met" : "" } viewBox="0 0 25 25">
                        <circle cx="12.5" cy="12.5" r="10"></circle>
                    </svg>
                    <svg className={ props.technology.level >= 4 ? "skill-met" : "" } viewBox="0 0 25 25">
                        <circle cx="12.5" cy="12.5" r="10"></circle>
                    </svg>
                    <svg className={ props.technology.level >= 5 ? "skill-met" : "" } viewBox="0 0 25 25">
                        <circle cx="12.5" cy="12.5" r="10"></circle>
                    </svg>
                </div>
            </div>
